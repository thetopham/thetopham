    ...
    <div className="relative flex min-h-screen w-screen flex-col items-center justify-center overflow-hidden bg-gradient-to-tl from-black via-zinc-600/20 to-black px-5">
      ...
      <main className="z-10 flex max-w-5xl flex-col items-center text-center">
        <p className="mb-5 font-mono text-xs font-semibold uppercase tracking-[0.32em] text-green-300/80 sm:text-sm">
          AI systems · persistent worlds · multimodal storytelling
        </p>
        ...
        <p className="mt-7 max-w-3xl text-base leading-7 text-zinc-300 sm:text-lg">
          Building systems that remember worlds—and turn them into experiences.
        </p>
        <p className="mt-2 max-w-2xl text-sm leading-6 text-zinc-500 sm:text-base">
          AI runtimes, world-state infrastructure, roleplay-to-animation pipelines,
          local models, and the occasional civilization-scale thought experiment.
        </p>
        <div className="mt-8 flex flex-wrap items-center justify-center gap-3">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-lg border border-green-400/50 bg-green-400/10 px-5 py-3 font-mono text-sm font-bold text-green-300 transition hover:bg-green-400/20"
          >
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="rounded-lg border border-zinc-600 bg-black/50 px-5 py-3 font-mono text-sm font-bold text-zinc-200 transition hover:border-zinc-400 hover:text-white"
          >
            resume ↗
          </a>
        </div>
